...
def html(content: str) -> dict[str, str | None]:
...
def png(content: str, name: str = "Image") -> dict[str, str | None]:
    return image(content, name, mime_type="image/png", extension="png")


def jpg(content: str, name: str = "Image") -> dict[str, str | None]:
    return image(content, name, mime_type="image/jpeg", extension="jpg")


def svg(content: str, name: str = "Image") -> dict[str, str | None]:
    return image(content, name, mime_type="image/svg+xml", extension="svg")


def json(content: str, name: str = "JSON") -> dict[str, str | None]:
    return extra(content, FORMAT_JSON, name, "application/json", "json")


def text(content: str, name: str = "Text") -> dict[str, str | None]:
    return extra(content, FORMAT_TEXT, name, "text/plain", "txt")


def url(content: str, name: str = "URL") -> dict[str, str | None]:
...
def mp4(content: str, name: str = "Video") -> dict[str, str | None]:
